(function () {
    ...
    angular
        .module('app.edittask',['blocks.session'])
        .controller('EditTaskController', EditTaskController);

    EditTaskController.$inject = ['logger','dataservice','$rootScope','$state','session'];
    /* @ngInject */
    function EditTaskController(logger,dataservice,$rootScope,$state,session) {
        var vm = this;
        vm.title = 'Edit Task';
        ...
        function activate() {
            logger.info('Activated Edit Task View');
